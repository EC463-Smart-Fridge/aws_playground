    ...
    try:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                return {"name": name, "category" : category, "calories" : calories}
...
def insert_item(uid, upc, response_info, product_name):
    ...
    exp_pred = predict_expiration(generic_name.lower())
...
def lambda_handler(event, context):
    ...
    if (product_name):
        searchType = "smartScan"
    else:
        searchType = "upc"

    response_info = findProductUsingUPC(upc, api_key, searchType)
